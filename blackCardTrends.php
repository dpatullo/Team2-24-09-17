  ...
  <form action="" method="post">
    ...
    <?php
          ...
          include('connectToDatabase.php');
           ...
           // $qr = $conn->query("CALL update_blackcardentries_view('2017-05-19 17:00:00', '2017-05-20 02:59:59')");
            $qr = $conn->query("CALL black_Card_Night_Out_Spending('$first_Datetime', '$last_Datetime')");
            $times = array();
